...
case class StoreOffset2Zk(domain: String, userid: String, cs: Long, timestamp: String, flag: String) {}

object StoreOffset2Zk {
  ...
  def parseLine(line: String, channel: Channel): StoreOffset2Zk = {
    ...
    */
    ...
    StoreOffset2Zk(domain, userid, cs, String.valueOf(timestamp), flag)
  }

  def apply(line: String, channel: Channel): StoreOffset2Zk = {
    try {
  ...
  def main(args: Array[String]) {
    ...
    for (log <- arr) {
      val fc = StoreOffset2Zk(log, Channel.update())
